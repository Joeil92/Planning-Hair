...
export default function Page() {
  ...
  return (
    <Container className="h-screen flex">
        ...
        <Container className="w-96 h-80 my-32 m-auto">
          {formStep === "register" ? (
            ...
            <>
              ...
              <Typography className="mb-16 text-center">
                Les informations pourront être changé ultérieurement
              </Typography>
              <CompanyForm />
            </>
          )}
      ...
      <Container
        className={`w-6/12 h-screen inline-block ${styles.rightContainer}`}
      >
        <></>
      </Container>
    </Container>
